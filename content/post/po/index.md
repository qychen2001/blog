...
- \beta \mathbb{D}_{\mathrm{KL}}\left(\pi(y|x) \| \pi_{\text{ref}}(y|x)\right),
$$
...
- \beta \mathbb{D}_{\mathrm{KL}}(\pi(y|x) \| \pi_{\text{ref}}(y|x)).
$$
...
### 4.2 DPO 为什么能省掉 reward model 和 PPO？
